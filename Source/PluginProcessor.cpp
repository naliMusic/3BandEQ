...
void _3BandEQAudioProcessor::prepareToPlay (double sampleRate, int samplesPerBlock)
{
    ...
    switch (chainSettings.lowCutSlope)
    {
        case Slope_12:
        {
            *leftLowCut.get<0>().coefficients = *cutCoffs[0];
        ...
        case Slope_24:
        {
            *leftLowCut.get<0>().coefficients = *cutCoffs[0];
            leftLowCut.setBypassed<0>(false);
            *leftLowCut.get<1>().coefficients = *cutCoffs[1];
        ...
        case Slope_36:
        {
            ...
            *leftLowCut.get<1>().coefficients = *cutCoffs[1];
            leftLowCut.setBypassed<1>(false);
            *leftLowCut.get<2>().coefficients = *cutCoffs[2];
        ...
        case Slope_48:
        {
            ...
            *leftLowCut.get<2>().coefficients = *cutCoffs[2];
            leftLowCut.setBypassed<2>(false);
            *leftLowCut.get<3>().coefficients = *cutCoffs[3];
    ...
    switch (chainSettings.lowCutSlope)
    {
        case Slope_12:
        {
            *rightLowCut.get<0>().coefficients = *cutCoffs[0];
        ...
        case Slope_24:
        {
            *rightLowCut.get<0>().coefficients = *cutCoffs[0];
            rightLowCut.setBypassed<0>(false);
            *rightLowCut.get<1>().coefficients = *cutCoffs[1];
        ...
        case Slope_36:
        {
            ...
            *rightLowCut.get<1>().coefficients = *cutCoffs[1];
            rightLowCut.setBypassed<1>(false);
            *rightLowCut.get<2>().coefficients = *cutCoffs[2];
        ...
        case Slope_48:
        {
            ...
            *rightLowCut.get<2>().coefficients = *cutCoffs[2];
            rightLowCut.setBypassed<2>(false);
            *rightLowCut.get<3>().coefficients = *cutCoffs[3];
